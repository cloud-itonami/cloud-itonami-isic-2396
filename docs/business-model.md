# Business Model: Cutting, shaping and finishing of stone
...
## Classification
- Repository: `cloud-itonami-isic-2396` ([github.com/cloud-itonami/cloud-itonami-isic-2396](https://github.com/cloud-itonami/cloud-itonami-isic-2396))
- ISIC Rev.5: `2396` — Cutting, shaping and finishing of stone
- Domain: `:stone-cutting-shaping-finishing/manufacturing`
- Social impact: :worker-safety :materials-safety :resource-efficiency
- Actor: `:dimension-stone-plant-operations-governor` — an independent Governor in the fleet's Sealed-LLM
...
## Customer
An operator running this vertical as an OSS business — :stone-cutting-shaping-finishing/manufacturing — who wants
...
One managed tenant (:stone-cutting-shaping-finishing/manufacturing):
...
- Do not bypass the `:dimension-stone-plant-operations-governor` for production decisions.
