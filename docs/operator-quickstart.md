# Operator Quickstart — Cutting, shaping and finishing of stone

Shortest path from clone to a verified local dry-run for **ISIC 2396** (`cloud-itonami-isic-2396`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-2396.git
cd cloud-itonami-isic-2396
```
...
- Blueprint governor key: `dimension-stone-plant-operations-governor`
- Likely source path: `stonemfg.governor.cljc`
